...
const lenderData=require('../data/LenderData.json')
...
const prioritizeLoans = async (req, res) => {
  try {
    ...
    const prioritizedLoans = loanOffers
      .sort((a, b) => 
        a.monthlyRepayment - b.monthlyRepayment || 
        b.term - a.term || 
...
const recommendLendersByCriteria = async (req, res) => {
  try {
